...
def main():
    ...
    if args.ctech == 'wsereg':
        archivo = args.variable[0] + '_mme_' + calendar.month_abbr[args.IC[0]] + '_' + SSS +\
                '_gp_01_p_' + '{:03}'.format(args.mod_spread[0]) +'_'+ args.wtech[0]+'_'+\
                args.ctech + '_p_'+'{:03}'.format(args.mme_spread[0])+'_hind.npz'
    else:
        archivo = args.variable[0] + '_mme_' + calendar.month_abbr[args.IC[0]] + '_' + SSS +\
                '_gp_01_p_' + '{:03}'.format(args.mod_spread[0]) +'_'+ args.wtech[0]+'_'+ args.ctech + '_hind.npz'
