...
def main():
    ...
    file_end = args.variable[0] + '_mme_' + calendar.month_abbr[args.IC[0]] +\
    '_' + SSS + '_gp_01_' + args.wtech[0] + '_' + args.ctech + '_hind'
...
# =============================================================================
    ...
    for i in np.arange(nlats):
        for j in np.arange(nlons):
            ...
            (1 - prob_terc_comb[1, :, i, j], obs_terciles[2, :, i, j], bins)
    ...
    verif_scores.plot_scores(lat, lon, -BSS_above[3, :, :] /
    ...
    verif_scores.plot_scores(lat, lon, -BSS_below[3, :, :] /
                             BSS_above[1, :, :], titulo, salida)
#    #AUROC 
    auroc_above = verif_scores.auroc(1 - prob_terc_comb[1, :, :, :],
    ...
    [roc_above, roc_below, hrr_above, farr_above, hrr_below, farr_below,
     hrrd_above, hrrd_below] = verif_scores.rel_roc(prob_terc_comb,
                                                    obs_terciles, lat, bins,
                                                    route, salida)
    ...
    [roc_above, roc_below, hrr_above, farr_above, hrr_below, farr_below,
     hrrd_above, hrrd_below] = verif_scores.rel_roc(prob_terc_comb_trop_SA,
    ...
    [roc_above, roc_below, hrr_above, farr_above, hrr_below, farr_below,
     hrrd_above, hrrd_below] = verif_scores.rel_roc(
